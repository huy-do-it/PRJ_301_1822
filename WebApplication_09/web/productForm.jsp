                ...
                <form action="ProductController" method="post">
                    ...
                    <div class="form-group"> 
                        ...
                        <% if (errors != null && errors.get("id") != null) { %>
                            <div class="error-message"><%= errors.get("id") %></div>
                        <% } %>
                    </div>
                    ...
                    <div class="form-group"> 
                        ...
                        <% if (errors != null && errors.get("image") != null) { %>
                            <div class="error-message"><%= errors.get("image") %></div>
                        <% } %>
                    </div>
                    ...
                    <div class="form-group"> 
                        ...
                        <% if (errors != null && errors.get("size") != null) { %>
                            <div class="error-message"><%= errors.get("size") %></div>
                        <% } %>
                    </div>
                    ...
                    <div class="button-group"> 
                        ...
                        <input type="reset" value="Reset" onclick="window.location.href='productForm.jsp'" />   
                    </div>
                </form>
                <% if (errors != null && errors.get("general") != null) { %>
                    <div class="error-message"><%= errors.get("general") %></div>
                <% } %>
